      ...
      <form className="bg-white p-8 sm:p-10 rounded-3xl shadow-lg shadow-gray-200/50 w-full max-w-sm space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 pt-1 border-t border-gray-100">
            ...
            <p className="text-xs text-gray-400 font-medium mb-1.5 leading-snug">Generate this in your Canvas profile settings. We secure it with AES-256 encryption.</p>
        ...
        <button formAction={signup} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 rounded-xl transition-all shadow-md mt-4 active:scale-[0.98]">
          Sign Up
        </button>
      </form>
