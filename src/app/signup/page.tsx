...
export default function SignupPage() {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gray-50 flex-col px-4 font-sans">
      <form action={formAction} className="bg-white p-8 sm:p-10 rounded-3xl shadow-lg shadow-gray-200/50 w-full max-w-sm space-y-6">
        ...
        <button disabled={isPending} type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 rounded-xl transition-all shadow-md mt-4 active:scale-[0.98] disabled:opacity-50">
